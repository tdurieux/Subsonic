...
public class DownloadServiceTest extends
	...
	/**
	 * Test downloads without downloads.
	 */
	...
	public void testNextWithPlayList() throws InterruptedException {
		...
		downloadService.download(this.createMusicSongs(2), false, false, false, false, 0, 0);
	...
	public void testTogglePlayPauseWithoutPlayList() {
		...
		assertEquals(oldPlayState, IDLE);
		assertEquals(newPlayState, IDLE);
	}
	...
	public void testAutoplay() throws InterruptedException{
		// Download one songs
		downloadService.getDownloads().clear();
		downloadService.download(this.createMusicSongs(1), false, true, false, false, 0, 0);
	...
	public void testAddMusicToDownload(){
		...
		// Launch download
		downloadService.download(this.createMusicSongs(1), false, false, false, false, 0, 0);
	...
	private List<MusicDirectory.Entry> createMusicSongs(int size){
		...
		musicEntry.setPath("The Dada Weatherman/Itchy Hitchhiker/08 - The Dada Weatherman - Harmonies.mp3");
